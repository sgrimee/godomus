# bash completion for ldclient                             -*- shell-script -*-
...
_ldclient_get_rooms()
{
    last_command="ldclient_get_rooms"
    commands=()
...
_ldclient_get_scenarios()
{
    last_command="ldclient_get_scenarios"
    commands=()
...
_ldclient_get_sites()
{
    last_command="ldclient_get_sites"
    commands=()
...
_ldclient_get_users()
{
    last_command="ldclient_get_users"
    commands=()
...
if [[ $(type -t compopt) = "builtin" ]]; then
    complete -o default -F __start_ldclient ldclient
else
    complete -o default -o nospace -F __start_ldclient ldclient
fi
